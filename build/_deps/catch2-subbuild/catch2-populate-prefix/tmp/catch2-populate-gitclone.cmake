...
execute_process(
  COMMAND ${CMAKE_COMMAND} -E rm -rf "/Users/fozua/Desktop/C-My-Http/build/_deps/catch2-src"
  RESULT_VARIABLE error_code
)
if(error_code)
  message(FATAL_ERROR "Failed to remove directory: '/Users/fozua/Desktop/C-My-Http/build/_deps/catch2-src'")
endif()
...
while(error_code AND number_of_tries LESS 3)
  execute_process(
    ...
    WORKING_DIRECTORY "/Users/fozua/Desktop/C-My-Http/build/_deps"
    RESULT_VARIABLE error_code
  )
...
execute_process(
  COMMAND "/opt/homebrew/bin/git"
          checkout "v3.4.0" --
  WORKING_DIRECTORY "/Users/fozua/Desktop/C-My-Http/build/_deps/catch2-src"
  RESULT_VARIABLE error_code
)
if(error_code)
...
if(error_code)
  message(FATAL_ERROR "Failed to update submodules in: '/Users/fozua/Desktop/C-My-Http/build/_deps/catch2-src'")
endif()
